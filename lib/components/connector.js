...
var verifyMessage = function(self, session, msg) {
  ...
  if(!pubKey.verifyString){
    //[Jasion]解决转接加密问题
    var __key = session.get("__key");
    var pubKey2 = new rsa.Key();
    pubKey2.n = new rsa.BigInteger(__key.rsa_n, 16);
    pubKey2.e = __key.rsa_e;
    return pubKey2.verifyString(message, sig)
  }
